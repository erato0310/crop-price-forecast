...
┌──────────────────────────────────────────────────────────────────────┐
│ [2026-08-12 확인] **상추는 KREI 관측 대상 품목이 아니다.**             │
│                                                                      │
│ 엽근채소 관측월보(aglook.krei.re.kr/main/uObserveMonth/OVR0000000008) │
│ 는 배추·무·당근·양배추 4품목만 다룬다. 상추는 없다.                    │
│                                                                      │
│ 따라서 상추 프로젝트에서는 이 경로가 **사용 불가**하고, 아래에 적힌     │
│ '월보 API 신청 권장'도 상추에 대해서는 신청할 이유가 없다.             │
│ 이 파일은 과채(토마토·수박·오이·멜론) 확장 시에만 의미가 있다.          │
└──────────────────────────────────────────────────────────────────────┘
